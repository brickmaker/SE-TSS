# Generated by Django 2.0 on 2018-05-31 09:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semester', models.PositiveSmallIntegerField(choices=[(0, '春'), (1, '夏'), (2, '春夏'), (3, '秋'), (4, '秋冬'), (5, '短')], default=0, verbose_name='开课学期')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('depart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='major', to='authentication.Department', verbose_name='所在院系')),
            ],
        ),
        migrations.CreateModel(
            name='Major_Class',
            fields=[
                ...
                ('major', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='class_name', to='authentication.Major', verbose_name='开设专业')),
            ],
        ),
        migrations.CreateModel(
            name='People',
