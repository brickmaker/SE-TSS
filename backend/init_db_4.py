...
def init_user():
    ...
    create(name="张四", id_id="3150100001")
    create(name="张五", id_id="3150100002")
    create(name="张六", id_id="3150100003")
...
def init_thread():
    ...
    create(title="文章05", poster_id="1", section_id=42, content="这是标记锚点")
    create(title="文章06", poster_id="2", section_id=36, content="白日依山尽")
    create(title="文章07", poster_id="1", section_id=43, content="黄河入海流")
    create(title="文章08", poster_id="2", section_id=36, content="欲穷千里目")
    create(title="文章09", poster_id="1", section_id=44, content="更上一层楼")
    create(title="文章10", poster_id="2", section_id=42, content="锄禾日当午")
