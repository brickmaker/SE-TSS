                ...
                <div>
                    <Button
                        ...
                        onClick={(e=>{
                            ...
                            fetch(`http://47.100.233.129:8080/api/online_testing/examination/${exam_id}/conservation/`, {
                                method: 'POST',
                                headers: headers,
                                body:JSON.stringify({
                                    answers:answer
                ...
                >
                    ...
                    <DialogActions>
                        ...
                        <Button onClick={(e)=>{
                            ...
                            fetch(`http://47.100.233.129:8080/api/online_testing/examination/${exam_id}/submission/`, {
                                method: 'POST',
                                headers: headers,
                            })
                                .then(response =>response.json())
