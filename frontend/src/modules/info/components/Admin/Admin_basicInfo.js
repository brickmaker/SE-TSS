...
class Admin_basicInfo extends React.Component {
    ...
    constructor(props) {
        ...
        let status;
        let url = '/api/admin/' + localStorage.getItem('userName') + '/';
            fetch(url, {
                method: 'GET',
                headers: {
   ...
   onChange(info) {
    ...
    edit(e){
       alert('123');
        let url = '/api/admin/' + this.state.username + '/';
        let data={};
...
export default withStyles(styles, {withTheme: true})(connect(mapStateToProps, mapDispatchToProps)(Admin_basicInfo))
