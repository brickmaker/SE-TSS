...
class Stu_basicInfo extends React.Component {
    ...
    constructor(props) {
        ...
        let status;
        let url = '/api/student/' + localStorage.getItem('userName') + '/';
            fetch(url, {
                method: 'GET',
                headers: {
   ...
   onChange(info) {
    ...
    edit(e){
       alert('123');
        let url = '/api/student/' + this.state.username + '/';
        let data={};
...
Stu_basicInfo.propType = {
    userName: PropTypes.string,
    classes: PropTypes.object.isRequired,
    theme: PropTypes.object.isRequired,
};
export default withStyles(styles, {withTheme: true})(connect(mapStateToProps, mapDispatchToProps)(Stu_basicInfo));
