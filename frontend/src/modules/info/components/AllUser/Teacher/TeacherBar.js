...
class TeacherBar extends React.Component {
    state = {
        anchor: 'left',
        anchorEl: null,
    };
...
TeacherBar.propTypes = {
    classes: PropTypes.object.isRequired,
    theme: PropTypes.object.isRequired,
};
export default withStyles(styles, {withTheme: true})(connect(mapStateToProps, mapDispatchToProps)(TeacherBar));
