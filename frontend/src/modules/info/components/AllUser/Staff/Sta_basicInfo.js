...
class Sta_basicInfo extends React.Component {
    ...
    constructor(props) {
        ...
        // this.state.id_number = '1233';

        let status;
        let url = '/api/staff/' + localStorage.getItem('userName') + '/';
            fetch(url, {
                method: 'GET',
                headers: {
   ...
   onChange(info) {
    ...
    edit(e){
       alert('123');
        let url = '/api/staff/' + this.state.username + '/';
        let data={};
...
Sta_basicInfo.propType = {
    userName: PropTypes.string,
    classes: PropTypes.object.isRequired,
    theme: PropTypes.object.isRequired,
};
export default withStyles(styles, {withTheme: true})(connect(mapStateToProps, mapDispatchToProps)(Sta_basicInfo));
